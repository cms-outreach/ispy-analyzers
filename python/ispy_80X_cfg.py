...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('file://emu_fevt_w_digis.root')
                            )
...
process.add_(
    ...
    outputFileName = cms.untracked.string('emu.ig'),
...
process.ISpyPFJet.iSpyPFJetTag = cms.InputTag('ak8PFJets')
