...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('/store/data/Commissioning12/Commissioning/RECO/PromptReco-v1/000/190/389/FCA393ED-9880-E111-A3B5-001D09F2437B.root')
                            )
...
process.add_(
    ...
    outputFileName = cms.untracked.string('/afs/cern.ch/work/m/mccauley/ispy.ig'),
    outputIg = cms.untracked.bool(True),
    outputMaxEvents = cms.untracked.int32(100), # These are the number of events per ig file 
    debug = cms.untracked.bool(False)
    )
)

process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(100) # These are the number of events to cycle through in the input root file
)
